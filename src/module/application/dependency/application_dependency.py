...
from src.database.postgres.models.db_models import Application, Business
...
def get_application_service(
    ...
    return ApplicationService(email_service=email_service, review_service=review_service)
