...
for SECRET in POSTGRES_URL LOG_LEVEL SUPABASE_PUBLISHABLE_KEY SUPABASE_PROJECT_URL SUPABASE_PROJECT_REF SUPABASE_JWT_AUDIENCE SUPABASE_SERVICE_ROLE_KEY S3_REGION S3_ACCESS_KEY_ID S3_SECRET_ACCESS_KEY_ID S3_ENPOINT SUPABASE_DEV_USERNAME SUPABASE_DEV_PASSWORD GOOGLE_PLACES_API_KEY RESEND_API_KEY; do
